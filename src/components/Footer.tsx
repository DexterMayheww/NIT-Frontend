...
export function Footer() {
  ...
  return (
    <footer className="bg-[#001D1B] pt-20 pb-10 px-4 border-t border-[#006A58]">
      <div className="grid grid-cols-1 gap-10 mx-auto text-sm text-gray-300 max-w-7xl md:grid-cols-2 lg:grid-cols-5">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#006A58] flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
