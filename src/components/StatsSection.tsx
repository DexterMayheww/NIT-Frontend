...
const CounterBubble = ({ value, label, className, iconPath }: { value: number, label: string, className: string, iconPath: JSX.Element }) => {
  ...
  return (
    <div 
      ref={bubbleRef} 
      // Added border-white/10 and changed bg-opacity for better overlapping visibility
      className={`absolute rounded-full flex flex-col items-center justify-center text-black bg-teal-400/60 backdrop-blur-md border border-white/10 shadow-[0_0_40px_rgba(45,212,191,0.2)] transition-all duration-500 hover:scale-103 hover:z-50 ${className}`}
    >
      <div className="mb-1">
      ...
      <div className="text-xl md:text-3xl font-bold leading-none tracking-tight">{displayValue}+</div>
      <div className="text-[10px] md:text-sm font-bold uppercase tracking-tight mt-1 px-3 text-center leading-tight">
        {label}
      </div>
    </div>
  );
  ...
  return (
    <section className="py-20 bg-[#002A28] overflow-hidden">
      <div className="mx-auto text-center max-w-7xl px-4">
        <h2 className="mb-16 text-5xl font-bold text-white">Our Numbers</h2>
        
        {/* Main relative container - height adjusted for tighter cluster */}
        <div className="relative h-[450px] md:h-[600px] w-full max-w-4xl mx-auto">
          
          {/* Citations - Center Large (z-40 to stay on top) */}
          <CounterBubble 
            value={stats.citations} 
            label="Citations" 
            className="w-44 h-44 md:w-72 md:h-72 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 bg-teal-400/80"
          ...
          <CounterBubble 
            value={stats.patents} 
            label="Patents" 
            className="w-28 h-28 md:w-44 md:h-44 top-[12%] left-[20%] md:top-[15%] md:left-[22%] z-30"
          ...
          <CounterBubble 
            value={stats.staff} 
            label="Staff" 
            className="w-28 h-28 md:w-40 md:h-40 top-[40%] left-[5%] md:left-[12%] z-20"
          ...
          <CounterBubble 
            ...
            label="Ph.D Produced" 
            className="w-28 h-28 md:w-36 md:h-36 bottom-[15%] left-[18%] md:bottom-[20%] md:left-[25%] z-10"
          ...
          <CounterBubble 
            ...
            label="Students" 
            className="w-28 h-28 md:w-40 md:h-40 bottom-[5%] left-[40%] md:bottom-[10%] md:left-[42%] z-30"
          ...
          <CounterBubble 
            ...
            label="Faculties" 
            className="w-28 h-28 md:w-40 md:h-40 top-[12%] right-[20%] md:top-[12%] md:right-[22%] z-30"
          ...
          <CounterBubble 
            ...
            label="Publications" 
            className="w-32 h-32 md:w-48 md:h-48 top-[35%] right-[5%] md:right-[10%] z-20"
          ...
          <CounterBubble 
            ...
            label="Departments" 
            className="w-28 h-28 md:w-36 md:h-36 bottom-[18%] right-[18%] md:bottom-[20%] md:right-[25%] z-10"
