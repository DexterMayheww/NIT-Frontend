...
export default async function CivilEngineeringPage() {
    ...
    const data = await getDrupalData('/department/electronics-communication-engineering', IMG_ONLY);
              ...
              <div className="mb-10 overflow-hidden rounded-2xl shadow-2xl border border-gray-200">
                {deptImage ? (
                  <div className="relative group">
                    <Image
                      src={deptImage.url}
                      alt={deptImage.alt || 'Electronics Communication Engineering Department'}
                      width={1000}
                      height={600}
